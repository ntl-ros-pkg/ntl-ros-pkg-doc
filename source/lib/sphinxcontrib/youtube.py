...
def visit_youtube_node(self, node):
    ...
    if (height is None) and (width is not None) and (width[1] == "%"):
        ...
        self.body.append(self.starttag(node, "iframe width=\"560\" height=\"315\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen", **attrs))
        self.body.append("</iframe></div></p>")
